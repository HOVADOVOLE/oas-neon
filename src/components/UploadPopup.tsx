...
const UploadPopup: React.FC<UploadPopupProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-gray-900 text-white p-6 rounded-lg shadow-lg w-11/12 sm:w-3/4 md:w-1/2 lg:w-1/3">
          ...
          <>
            ...
            <div className="flex justify-between">
              ...
              <button
                ...
                className="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg shadow-md focus:outline-none"
              >
                Nahrát
              </button>
            </div>
